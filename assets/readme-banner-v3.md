...
```text
A strange attractor rendered as a folded, stretched luminous ribbon looping through space, its surface built from thousands of fine glowing electric cyan-teal trajectory threads that wind, fold and re-fold onto themselves. Warm coral picks out the densest folds where trajectories crowd together. The form sits centre-right with open dark space around it.
```
